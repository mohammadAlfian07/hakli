...
public class P2kbB14DetailVm {
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbb14> objList = oDao.listByFilter("mp2kbkegiatan.mp2kbkegiatanpk = " + p2kb.getMp2kbkegiatan().getMp2kbkegiatanpk() + " and tanggota.tanggotapk = " + p2kb.getTanggota().getTanggotapk(), "tp2kbb14pk desc");
