...
public class P2kbB13DetailVm {
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbb13> objList = oDao.listByFilter("mp2kbkegiatan.mp2kbkegiatanpk = " + p2kb.getMp2kbkegiatan().getMp2kbkegiatanpk() + " and tanggota.tanggotapk = " + p2kb.getTanggota().getTanggotapk(), "tp2kbb13pk desc");
