...
public class P2kbD02DetailVm {
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbd02> objList = oDao.listByFilter("mp2kbkegiatan.mp2kbkegiatanpk = " + p2kb.getMp2kbkegiatan().getMp2kbkegiatanpk() + " and tanggota.tanggotapk = " + p2kb.getTanggota().getTanggotapk(), "tp2kbd02pk desc");
