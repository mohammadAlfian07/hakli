...
public class P2kbD01DetailVm {
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbd01> objList = oDao.listByFilter("mp2kbkegiatan.mp2kbkegiatanpk = " + p2kb.getMp2kbkegiatan().getMp2kbkegiatanpk() + " and tanggota.tanggotapk = " + p2kb.getTanggota().getTanggotapk(), "tp2kbd01pk desc");
