...
public class P2kbE02DetailVm {
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbe02> objList = oDao.listByFilter("mp2kbkegiatan.mp2kbkegiatanpk = " + p2kb.getMp2kbkegiatan().getMp2kbkegiatanpk() + " and tanggota.tanggotapk = " + p2kb.getTanggota().getTanggotapk(), "tp2kbe02pk desc");
