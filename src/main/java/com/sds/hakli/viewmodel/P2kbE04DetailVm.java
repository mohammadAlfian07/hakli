...
public class P2kbE04DetailVm {
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbe04> objList = oDao.listByFilter("mp2kbkegiatan.mp2kbkegiatanpk = " + p2kb.getMp2kbkegiatan().getMp2kbkegiatanpk() + " and tanggota.tanggotapk = " + p2kb.getTanggota().getTanggotapk(), "tp2kbe04pk desc");
