...
public class P2kbA01DetailVm {
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kba01> objList = oDao.listByFilter("mp2kbkegiatan.mp2kbkegiatanpk = " + p2kb.getMp2kbkegiatan().getMp2kbkegiatanpk() + " and tanggota.tanggotapk = " + p2kb.getTanggota().getTanggotapk(), "tp2kba01pk desc");
